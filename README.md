...
The charts are produced using AMCHARTS.
	...
	linq@3.2.4 (make sure you get the version referenced here: https://github.com/mihaifm/linq / npm install linq@3)
